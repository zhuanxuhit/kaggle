...
if __name__ == "__main__":
    ...
    feat_names = [
        ...
        ## Word count ##
        ################
        ('count_of_query_unigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_query_unigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_query_unigram', SimpleTransform()),
        ('count_of_query_bigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_query_bigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_query_bigram', SimpleTransform()),
        ('count_of_query_trigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_query_trigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_query_trigram', SimpleTransform()),
        ('count_of_digit_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_digit_in_query', SimpleTransform()),
        ('count_of_title_unigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_title_unigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_title_unigram', SimpleTransform()),
        ('count_of_title_bigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_title_bigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_title_bigram', SimpleTransform()),
        ('count_of_title_trigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_title_trigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_title_trigram', SimpleTransform()),
        ('count_of_digit_in_title', SimpleTransform(count_feat_transform)),
        ('ratio_of_digit_in_title', SimpleTransform()),
        ('count_of_description_unigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_description_unigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_description_unigram', SimpleTransform()),
        ('count_of_description_bigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_description_bigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_description_bigram', SimpleTransform()),
        ('count_of_description_trigram', SimpleTransform(count_feat_transform)),
        ('count_of_unique_description_trigram', SimpleTransform(count_feat_transform)),
        ('ratio_of_unique_description_trigram', SimpleTransform()),
        ('count_of_digit_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_digit_in_description', SimpleTransform()),
        ('count_of_query_unigram_in_title', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_unigram_in_title', SimpleTransform()),
        ('count_of_query_unigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_unigram_in_description', SimpleTransform()),
        ('count_of_title_unigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_unigram_in_query', SimpleTransform()),
        ('count_of_title_unigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_unigram_in_description', SimpleTransform()),
        ('count_of_description_unigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_description_unigram_in_query', SimpleTransform()),
        ('count_of_description_unigram_in_title', SimpleTransform(count_feat_transform)),
        ...
        ('count_of_query_bigram_in_title', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_bigram_in_title', SimpleTransform()),
        ('count_of_query_bigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_bigram_in_description', SimpleTransform()),
        ('count_of_title_bigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_bigram_in_query', SimpleTransform()),
        ('count_of_title_bigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_bigram_in_description', SimpleTransform()),
        ('count_of_description_bigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_description_bigram_in_query', SimpleTransform()),
        ('count_of_description_bigram_in_title', SimpleTransform(count_feat_transform)),
        ...
        ('count_of_query_trigram_in_title', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_trigram_in_title', SimpleTransform()),
        ('count_of_query_trigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_query_trigram_in_description', SimpleTransform()),
        ('count_of_title_trigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_trigram_in_query', SimpleTransform()),
        ('count_of_title_trigram_in_description', SimpleTransform(count_feat_transform)),
        ('ratio_of_title_trigram_in_description', SimpleTransform()),
        ('count_of_description_trigram_in_query', SimpleTransform(count_feat_transform)),
        ('ratio_of_description_trigram_in_query', SimpleTransform()),
        ('count_of_description_trigram_in_title', SimpleTransform(count_feat_transform)),
        ...
        ## Position ##
        ##############
        ('pos_of_title_unigram_in_query_min', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_query_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_query_median', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_query_max', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        ('pos_of_description_unigram_in_query_min', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_query_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_query_median', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_query_max', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        ('pos_of_query_unigram_in_title_min', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_title_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_title_median', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_title_max', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        ('pos_of_description_unigram_in_title_min', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_title_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_title_median', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_title_max', SimpleTransform(count_feat_transform)),
        ('pos_of_description_unigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        ('pos_of_query_unigram_in_description_min', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_description_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_description_median', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_description_max', SimpleTransform(count_feat_transform)),
        ('pos_of_query_unigram_in_description_std', SimpleTransform(count_feat_transform)),
        ...
        ('pos_of_title_unigram_in_description_min', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_description_mean', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_description_median', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_description_max', SimpleTransform(count_feat_transform)),
        ('pos_of_title_unigram_in_description_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_title_bigram_in_query_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_query_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_query_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_query_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_description_bigram_in_query_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_query_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_query_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_query_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_query_bigram_in_title_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_title_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_title_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_title_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_description_bigram_in_title_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_title_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_title_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_title_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_bigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_query_bigram_in_description_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_description_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_description_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_description_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_bigram_in_description_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_title_bigram_in_description_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_description_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_description_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_description_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_bigram_in_description_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_title_trigram_in_query_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_query_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_query_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_query_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_description_trigram_in_query_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_query_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_query_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_query_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_query_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_query_trigram_in_title_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_title_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_title_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_title_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_description_trigram_in_title_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_title_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_title_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_title_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_description_trigram_in_title_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_query_trigram_in_description_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_description_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_description_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_description_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_query_trigram_in_description_std', SimpleTransform(count_feat_transform)),
        ...
        # ('pos_of_title_trigram_in_description_min', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_description_mean', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_description_median', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_description_max', SimpleTransform(count_feat_transform)),
        # ('pos_of_title_trigram_in_description_std', SimpleTransform(count_feat_transform)),
